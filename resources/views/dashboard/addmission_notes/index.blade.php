...
@endsection
@section('content')
<a href="{{ url('addmission_notes/create') }}">
    <button class="btn btn-success" style="margin-bottom: 25px;">
        <i class="fa fa-plus "></i> اضافة مذكرة
    </button>
</a>

<div class="container mt-5">
    <h2 class="mb-4"> طلب مذكرة قبول</h2>
...
<script type="text/javascript">
    ...
    function reload(value=null)
    {
        ...
        ajax:
        {
            url : "{{ route('addmission_note.data') }}" ,
            method : "GET",
        ...
        columns: [
            ...
            {data: 'divison_name', name: 'divison_name'},
        ...
        function(event) {
            ...
            for (let i = 1; i < TRs.length; i++)
            {
                ...
                $(row).append("<td> " + datum.divison_name + " </td>")
                /* append name columns */
                ...
                $(row).append(
                    ...
                    /**Edit**/
                    +
                    "<a style='display:block' class='dropdown-item'href='{{ url('addmission_notes/edit') }}" + "/" + datum.id +
                    "'> تعديل</a>" +
                    "<a style='display:block' class='dropdown-item'href='{{ url('addmission_notes/delete') }}" + "/" + datum.id +
                    "'>  حذف</a>" + "</div></div> </td>")
            }
